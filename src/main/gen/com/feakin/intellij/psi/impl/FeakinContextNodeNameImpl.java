...
public class FeakinContextNodeNameImpl extends FeakinPsiCompositeElementImpl implements FeakinContextNodeName {

  public FeakinContextNodeNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FeakinVisitor visitor) {
    visitor.visitContextNodeName(this);
  }
