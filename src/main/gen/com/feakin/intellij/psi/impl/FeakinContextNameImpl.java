...
public class FeakinContextNameImpl extends FeakinPsiCompositeElementImpl implements FeakinContextName {

  public FeakinContextNameImpl(@NotNull ASTNode node) {
    super(node);
  }
