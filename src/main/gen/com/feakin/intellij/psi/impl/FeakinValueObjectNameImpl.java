...
public class FeakinValueObjectNameImpl extends FeakinPsiCompositeElementImpl implements FeakinValueObjectName {

  public FeakinValueObjectNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FeakinVisitor visitor) {
    visitor.visitValueObjectName(this);
  }
