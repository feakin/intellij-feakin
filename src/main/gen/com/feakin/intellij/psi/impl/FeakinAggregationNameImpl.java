...
public class FeakinAggregationNameImpl extends FeakinPsiCompositeElementImpl implements FeakinAggregationName {

  public FeakinAggregationNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FeakinVisitor visitor) {
    visitor.visitAggregationName(this);
  }
