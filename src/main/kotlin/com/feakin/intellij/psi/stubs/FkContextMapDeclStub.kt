...
class FkContextMapDeclStub(
    ...
    object Type : FkStubElementType<FkContextMapDeclStub, FeakinContextMapDeclaration>("FUNCTION") {
        ...
        override fun createPsi(stub: FkContextMapDeclStub): FeakinContextMapDeclaration {
